...
public class RegisterPlugin implements Plugin<Project> {
    ...
    static void init(Project project, RegisterTransform transformImpl) {
        ...
        registerInfoMap.put('scanInterface','com.laotang.quickdevcore.integration.ConfigModule')
        registerInfoMap.put('codeInsertToClassName','com.laotang.quickdevcore.base.delegate.AppDelegate')
